...
async function main() {
  ...
  const airAlgerie = await prisma.airlineCompany.upsert({
    ...
    create: {
      ...
      iataCode: 'RAM',
      logoUrl:
        'https://africandigitalsummit.ma/wp-content/uploads/2024/09/Logo_RAM.png',
  ...
  const airFrance = await prisma.airlineCompany.upsert({
    ...
    create: {
      ...
      iataCode: 'AF',
      logoUrl:
        'https://media.licdn.com/dms/image/v2/D4E0BAQFjH_FI8zqIyQ/company-logo_200_200/company-logo_200_200/0/1735644917367/air_france_logo?e=2147483647&v=beta&t=O78soV54OggnUJZDObjK6Fryo9DI9mC44nANGSAoiFk',
    },
  })
  ...
  const turkish = await prisma.airlineCompany.upsert({
    ...
    create: {
      ...
      iataCode: 'TK',
      logoUrl:
        'https://i.pinimg.com/736x/2a/8f/76/2a8f7693be88aa9f3137d5eb2ad5e5c4.jpg',
    },
  })
  ...
  const flights = await Promise.all([
    prisma.flight.upsert({
      ...
      create: {
        ...
        arrivalTime: new Date(
          now.getTime() + 2 * 24 * 60 * 60 * 1000 + 3.5 * 60 * 60 * 1000,
        ),
        price: 280,
        totalSeats: 180,
        availableSeats: 142,
    ...
    prisma.flight.upsert({
      ...
      create: {
        ...
        arrivalTime: new Date(
          now.getTime() + 5 * 24 * 60 * 60 * 1000 + 7 * 60 * 60 * 1000,
        ),
        price: 620,
        totalSeats: 320,
        availableSeats: 211,
    ...
    prisma.flight.upsert({
      ...
      create: {
        ...
        arrivalTime: new Date(
          now.getTime() + 7 * 24 * 60 * 60 * 1000 + 11 * 60 * 60 * 1000,
        ),
        price: 890,
        totalSeats: 350,
        availableSeats: 130,
  ...
  const hotel1 = await prisma.hotel.upsert({
    ...
    create: {
      ...
      city: 'Morocco',
      address: 'Telemly, Morocco, Algeria',
      stars: 5,
      description:
        'The prestigious 5-star hotel overlooking the Bay of Morocco.',
      imageUrl:
  ...
  const hotel2 = await prisma.hotel.upsert({
    ...
    create: {
      ...
      city: 'Morocco',
      address: 'Club des Pins, Staoueli, Morocco',
      stars: 5,
